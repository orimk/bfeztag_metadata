<div class="context-block">
    ...
    <div class="box-content">
        {if $tag.main_tag_id|eq( 0 )}
            ...
            {def $tag_extra_attributes = tag_get_expected_attributes($tag)}
            {if $tag_extra_attributes|count()|gt(0)}
                {include uri='design:parts/tags_attributes.tpl' extra_attributes=$tag_extra_attributes tag=$tag}
            {/if}
        {else}
